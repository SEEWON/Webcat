...
slack_channel = "h-경제학-학부-일반대학원공지"
detecting_website = (
    "https://econ.sogang.ac.kr/front/cmsboardlist.do?siteId=econ&bbsConfigFK=2607"
)
...
for i in range(1, 16):
    notice = {
        ...
        "registered_date": f"/html/body/div/div[4]/div[2]/div[4]/div/div/ul/li[{i}]/div/div/span[3]",
    }
