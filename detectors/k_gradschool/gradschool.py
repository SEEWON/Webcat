...
slack_channel = "k-일반대학원-공지"
detecting_website = "https://gradsch.sogang.ac.kr/gradsch/index_new.html"
...
for j in range(2, 4):
    for k in range(1, 3):
        for i in range(1, 6):
            notice = {
                "title": f"/html/body/div[1]/div[2]/div/div[{j}]/div/div/div[{k}]/div/div/div/ul/li[{i}]/a",
                "registered_date": f"/html/body/div[1]/div[2]/div/div[{j}]/div/div/div[{k}]/div/div/div/ul/li[{i}]/span",
            }
