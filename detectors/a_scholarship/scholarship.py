...
for i in range(1, 35):
    notice = {
        "title": f"/html/body/div/div/div[2]/div/table/tbody/tr[{i}]/td[2]/div/a",
        "registered_date": f"/html/body/div/div/div[2]/div/table/tbody/tr[{i}]/td[5]",
    }
