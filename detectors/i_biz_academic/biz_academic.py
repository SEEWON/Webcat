...
slack_channel = "i-경영학-학부공지"
detecting_website = (
    "https://sbs.sogang.ac.kr/front/cmsboardlist.do?siteId=sbs&bbsConfigFK=2371"
)
...
for i in range(1, 15):
    notice = {
        "title": f"/html/body/div/div[4]/div[2]/div[3]/div/div/ul/li[{i}]/div/a",
        "registered_date": f"/html/body/div/div[4]/div[2]/div[3]/div/div/ul/li[{i}]/div/div/span[3]",
    }
